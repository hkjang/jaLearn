  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        elementary:
          "bg-gradient-to-r from-orange-400 to-amber-500 text-white shadow-sm hover:shadow-md",
        middle:
          "bg-gradient-to-r from-green-400 to-emerald-500 text-white shadow-sm hover:shadow-md",
        high:
          "bg-gradient-to-r from-indigo-400 to-purple-500 text-white shadow-sm hover:shadow-md",
      },
      size: {
        ...
        icon: "h-10 w-10",
        touch: "h-12 min-w-[44px] px-6 text-base", // Mobile-friendly touch target
      },
    },
    defaultVariants: {
      variant: "default",
